...
class ArtPagedListBuilder(private val boundaryCallback: ArtBoundaryCallback) {

    private val pageSize = 5

    fun getPagedList(cache: ArtsyCache, disposable: CompositeDisposable): Flowable<ArtPagedList> {
